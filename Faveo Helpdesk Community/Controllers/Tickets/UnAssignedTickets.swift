...
class UnAssignedTickets: UIViewController,UITableViewDataSource,UITableViewDelegate,RMControllerDelegate {
    ...
    func getTickets(){
        ...
        getInboxTicketsURL?.append("api/v1/helpdesk/unassigned")
        ...
        requestGETURL(getInboxTicketsURL!, params: ["token":tokenValue as AnyObject ],  success: { (data) in
         ...
         //   print("Inbox JSON is: ",data)
            ...
            print("Error From Unassigned Tickets API Call: \(error.localizedDescription)")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        GlobalVariables.sharedManager.fromVC = "unassignedTickets"
