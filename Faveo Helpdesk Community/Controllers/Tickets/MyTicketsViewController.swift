...
class MyTicketsViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,RMControllerDelegate {
    ...
    func getTickets(){
        ...
        getInboxTicketsURL?.append("api/v1/helpdesk/my-tickets-agent")
        
        let tokenValue = userDefaults.string(forKey:"token")
        let userId = userDefaults.string(forKey:"userId")
        // print("token=>",tokenValue!)
        
        requestGETURL(getInboxTicketsURL!, params: ["token":tokenValue as AnyObject, "user_id":userId as AnyObject],  success: { (data) in
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        GlobalVariables.sharedManager.fromVC = "myTickets"
