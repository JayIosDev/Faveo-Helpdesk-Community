...
class ClosedTickets: UIViewController,UITableViewDataSource,UITableViewDelegate,RMControllerDelegate {
    ...
    func getTickets(){
        ...
        getInboxTicketsURL?.append("api/v1/helpdesk/closed")
        ...
        requestGETURL(getInboxTicketsURL!, params: ["token":tokenValue as AnyObject ],  success: { (data) in
          ...
          //  print("Inbox JSON is: ",data)
            ...
            print("Error From Closed Tickets API Call: \(error.localizedDescription)")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        GlobalVariables.sharedManager.fromVC = "closedTickers"
